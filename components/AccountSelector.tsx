        ...
        <div className="flex items-center gap-4">
          <Ariakit.Select
            className={cn(
              button({
                className:
                  'group flex items-center gap-2 rounded-xl outline-offset-1 aria-expanded:bg-white aria-expanded:text-black aria-expanded:-outline-offset-2 aria-expanded:outline-primary aria-expanded:hover:bg-gray-light aria-expanded:focus:-outline-offset-2',
                theme: 'primary',
              }),
            )}
          >
        ...
        >
          ...
          <Ariakit.SelectList>
            {accounts.map(account => {
              return (
                <Ariakit.SelectItem
                  className="flex items-center gap-4 rounded-md px-4 py-2 ring-primary hover:bg-gray-light focus:ring-2 dark:hover:bg-gray-dark"
                  key={account.id}
                  value={account.id}
                  onClick={() => {
